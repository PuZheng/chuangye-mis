 ...
 *
 *   * $$view - a slot that holds a virtual dom (that is what to be patched
 *   into dom)
 ...
 *   * onUnmount(rootNode) - a function will be called when mountable
 *   unmount(this happends when other mountable mount)
