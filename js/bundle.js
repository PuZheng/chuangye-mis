...
var connect = function () {
  ...
  slots.forEach(function (slot, i) {
    slot.cbs.push(function (v) {
      ret.apply(ret, [computeValue.apply(void 0, slots.map(function (slot_, j) { return (i === j)? v: slot_.apply(slot_); }))]);
    });
    slot.children.push(ret);
  });
  ret.refresh = function () {
    this.apply(this, [computeValue.apply(void 0, slots.map(function (slot) { return slot.apply(slot); }))]);
  };
  return ret;
};

var update = function () {
  var slotValuePairs = [], len = arguments.length;
  while ( len-- ) slotValuePairs[ len ] = arguments[ len ];

  slotValuePairs.forEach(function (ref) {
    var slot = ref[0];
    var value = ref[1];
  ...
  var toUpdate = [];
  slotValuePairs.map(function (ref) {
    var slot = ref[0];
    var value = ref[1];
  ...
  toUpdate.forEach(function (slot) { return slot.refresh.apply(slot); });
};
...
var x = (function (p) {
  ...
  p.update = update;
  return p;
})(function (initial) { return makeSlot(initial); });
...
var morphdom = (index$3 && typeof index$3 === 'object' && 'default' in index$3 ? index$3['default'] : index$3);

function mount(slot, node, cb) {
  slot.change(function (newNode) {
    morphdom(node, newNode);
    cb(node);
  });
};

var pageTpl = "<div class=\"ui grid container\">\n  <div class=\"row\">\n    <div class=\"column\">\n      <div class=\"ui top attached blue message\">\n        <div class=\"ui header\">创建新发票</div>\n      </div>\n      <div class=\"ui bottom attached segment\">\n        <%- invoiceForm %>\n      </div>\n    </div>\n  </div>\n</div>\n\n";

var spuFormTpl = "<div class=\"ui form\">\n  <div class=\"required inline field\">\n    <label for=\"\">发票日期</label>\n    <input type=\"date\" name=\"date\">\n  </div>\n  <div class=\"required inline field\">\n    <label for=\"\">发票号码</label>\n    <input type=\"text\" name=\"number\">\n  </div>\n  <div class=\"required inline field\">\n    <label for=\"\">会计账期</label>\n    <select class=\"ui selection dropdown\" name=\"accountTerm\">\n      <option value=\"\">请选择会计账期</option>\n      <% accountTerms.forEach(function (t) { %>\n        <option value=\"<%= t.id %>\"><%= t.name %></option>\n      <% }) %>\n    </select>\n  </div>\n  <div class=\"required inline field\">\n    <label for=\"\">科目</label>\n    <select class=\"ui selection dropdown\" name=\"subject\">\n      <option value=\"\">请选择科目</option>\n      <% subjects.forEach(function (s) { %>\n        <option value=\"<%= s.id %>\"><%= s.id %></option>\n      <% }) %>\n    </select>\n  </div>\n  <div class=\"required inline field\">\n    <label for=\"\">(实际)销售方</label>\n    <select class=\"ui search selection dropdown\" name=\"vendor\" value=\"\">\n      <option value=\"\">选择销售方</option>\n      <% vendorCandidates.forEach(function (vendor) { %>\n        <option value=<%= vendor.id %>><%= vendor.name %></option>\n      <% }) %>\n    </select>\n  </div>\n  <div class=\"required inline field\">\n    <label for=\"\">(实际)购买方</label>\n    <select class=\"ui search selection dropdown\" name=\"vendor\" value=\"\">\n      <option value=\"\">选择购买方</option>\n      <% purchaserCandidates.forEach(function (purchaser) { %>\n        <option value=<%= purchaser.id %>><%= purchaser.name %></option>\n      <% }) %>\n    </select>\n  </div>\n  <div class=\"inline field\">\n    <div class=\"ui checkbox\">\n      <input type=\"checkbox\" name=\"creditPublicAccount\">\n      <label for=\"\">是否记入总账户?</label>\n    </div>\n  </div>\n  <div class=\"inline field\">\n    <label for=\"\">备注</label>\n    <textarea name=\"note\" rows=\"12\"></textarea>\n  </div>\n  <hr>\n  \n  <input type=\"submit\" class=\"ui green button\" value=\"提交\">\n  <style scoped>\n    .ui.form .inline.field > label:first-child {\n      width: 8em;\n    }\n    .inline.field textarea {\n      width: 24em;\n    }\n  </style>\n</div>\n";

var loading = x('loading');
var invoice = x('invoice');
var vendorCandidates = x('vendorCandidates');
var purchaserCandidates = x('purchaserCandidates');
var accountTerms = x('accountTerms');
var subjects = x('subjects');

var invoiceForm = x.connect(
  ...
  return ejs.render(spuFormTpl, {
    ...
    purchaserCandidates: purchaserCandidates,
    accountTerms: accountTerms,
    subjects: subjects
  });
}).tag('invoiceForm');
  
var view = x.connect(loading, invoiceForm, 
                           function (loading, invoiceForm) {
...
mount(view, container, function (node) {
  $(node).find('.ui.dropdown').dropdown();
});


var invoicePage = Object.freeze({
  loading: loading,
  invoice: invoice,
  vendorCandidates: vendorCandidates,
  purchaserCandidates: purchaserCandidates,
